...
feature "hidden links" do
  ...
  context "regular users" do
    ...
    scenario "New ticket link is shonw to a user with permission" do
    ...
    scenario "Edit ticket link is shown to a user with permission" do
      # this scenario needs the ticket created first to set correct permissions ticket
      ticket
      define_permission!(user, "view", project)
    ...
    scenario "Edit ticket link is hsidden from a user without permission" do
    ticket
    define_permission!(user, "view", project)
    visit project_path(project)
    click_link ticket.title
